...
import { AsyncIterableClass, RecursiveOrElement } from '../../src/index'
...
describe('AsyncIterable.concatAll', () => {
  it('should equal the same as a deeply nested Array.concatAll', () => {
    ...
    return AsyncIterableClass.from<RecursiveOrElement<number>>([a, b, c]).concatAll().toArray().then(concat => {
